...
interface DiscullaIconProps {
  className?: string;
  size?: "small" | "medium" | "large";
}

export const DiscullaIcon: React.FC<DiscullaIconProps> = ({ className = "", size = "medium" }) => {
  const sizeConfig = {
    small: {
      fontSize: "text-xl",
      height: "h-10",
    ...
    <div className={`relative inline-flex items-center justify-center ${className}`}>
      ...
      >
        ...
        <div className="relative">
          ...
          {/* Underline accent */}
          <motion.div
            className="absolute -bottom-2 left-0 right-0 h-0.5 bg-gradient-to-r from-transparent via-sky-500 to-transparent"
